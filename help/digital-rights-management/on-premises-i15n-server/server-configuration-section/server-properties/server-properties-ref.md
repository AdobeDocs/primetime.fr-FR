 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    </ul> <p>Veuillez lire la section Fichiers <i></i> CRL et ECI sur la mise à jour du cache. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td> 
    ...
    <p> <code>
     ...
     <p>Le serveur de licences doit télécharger automatiquement cette liste de révocation des certificats une fois qu’une demande de licence est traitée. </p> <p importance="high">Remarque : Ce point de distribution <i>n'est pas</i> vérifié par Primetime DRM pour vérifier sa validité. Vous devez vérifier que cette URL est valide. Les erreurs résultant d’une URL non valide n’apparaîtront que lorsque les erreurs de validation apparaîtront à partir du serveur de licences. </p> </td> 
  </tr> 
  <tr> 
   <td> Journalisation </td> 
   <td>Configurez le fichier <span class="filepath"> AdobeInitial.properties</span> pour effectuer la journalisation si nécessaire. </td> 
   <td> 
    <ul id="ul_j1v_kw2_jr"> 
     ...
     <li id="li_2DD4406FBBF047589BAAAE1C9082D8B3"><span class="codeph"> log.Level =</span> [Le niveau le plus bas de messages du journal qui peut apparaître dans les journaux <span class="codeph"> [DEBUG | INFO]</span> ] </li> 
     ...
     <li id="li_3F46C15488114BB5B41035F710E7A19F"><span class="codeph"> log.RollSize =</span> [Faire rouler les journaux lorsqu'ils atteignent cette taille (Les journaux s'affichent lorsque l' <span class="codeph"> Intervalle</span> de roulis ou la <span class="codeph"> Taille</span> de roulis est atteinte, selon ce qui vient en premier)] </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul id="ul_b3b_g1f_jr"> 
     ...
     <li id="li_5DA3C89770804B148EF6FAF01A5AD958"><span class="codeph"> keys.MinQueueSize =</span> [récupérer un autre lot de clés du KGS quand il reste tant de clés dans la file d'attente] </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul id="ul_kwq_12f_jr"> 
     ...
     <li id="li_0E34CD32CD5E47729B69B50414F93678"><span class="codeph"> log.FileName =</span> [Préfixe pour les fichiers journaux. L'extension Date/Heure et <span class="filepath"> .log</span> sera ajoutée au nom de fichier] </li> 
     <li id="li_8AB15ACEC39041A2A04C7301154C6EDB"><span class="codeph"> log.Level =</span> [Le niveau le plus bas de messages du journal qui peut apparaître dans les journaux] </li> 
