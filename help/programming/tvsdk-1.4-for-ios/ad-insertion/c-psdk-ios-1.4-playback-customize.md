...
1. Pour reprendre la vidéo à la même position : Pour reprendre la lecture de la vidéo à partir de la position enregistrée à partir d’une session précédente, utilisez `seekToLocalTime`
