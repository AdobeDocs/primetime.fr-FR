...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">Pour plus d’informations, voir <a href="../../tvsdk-1.4-for-android/ui-configure/android-1.4-ui-seek-scrub-bar-display.md">Affichage d’une barre de défilement de recherche avec la position de lecture actuelle</a>. </td> 
  </tr> 
 </tbody> 
</table>
