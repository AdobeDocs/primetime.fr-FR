...
>**Limitation**
>
>Lorsque HLS est lu en utilisant la variable `Video` Dans Safari, et non en utilisant la fonction Flash Fallback, cette fonctionnalité ne sera pas disponible dans Safari.
