---
description: TVSDK nécessite des exigences spécifiques pour le contenu multimédia, le contenu manifeste, les DRM et les versions logicielles.
title: Exigences
...
TVSDK nécessite des exigences spécifiques pour le contenu multimédia, le contenu manifeste, les DRM et les versions logicielles.
...
La version de dans le [!DNL .m3u8] fichier affecte les fonctionnalités disponibles pour votre application et les `EXT` balises valides dans votre liste de `#EXT-X-VERSION` lecture/manifeste.
