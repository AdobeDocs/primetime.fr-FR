...
# Contrôle du style de sous-titrage {#control-closed-caption-styling-overview}
...
Cette classe encapsule les informations de style de sous-titrage, telles que le type, la taille, la couleur et l’opacité de l’arrière-plan. Une classe d’assistance associée `TextFormatBuilder`facilite l’utilisation des paramètres de style de sous-titrage.
...
1. Attendez que le lecteur de médias soit au moins dans l’état PRÉPARÉ.
