...
Pour être informé de tous les événements liés à la gestion des droits numériques, enregistrez une mise en oeuvre de `MediaPlayer.DRMEventListener` qui inclut le rappel suivant.
