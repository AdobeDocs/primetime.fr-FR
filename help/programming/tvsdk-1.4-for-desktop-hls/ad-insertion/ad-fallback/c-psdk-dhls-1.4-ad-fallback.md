...
Le serveur principal Primetime et d’insertion conserve un ensemble de priorités afin de lui permettre de choisir parmi différents types de médias dans la même réponse VAST/VMAP. Vous pouvez en savoir plus sur cette  prioritaire et sur la façon de la modifier dans [Aperçu du CS Ex](../../../../dynamic-ad-insertion/creative-repackaging-service/crs-overview.md).
...
1. Définissez cette variable `fallbackOnInvalidCreative` sur true pour que VMAP soit de retour lorsque le type de média pour une publicité linéaire/intégrée n&#39;est pas valide pour HLS.
