 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Représentation numérique affectée à la notification : 
    ...
    </ul> <p>Chaque plage de niveau supérieur (erreurs, par exemple) est divisée en sous-plages, telles que 101000 à 101999, représentant les erreurs de lecture. </p>
    <pre>
     L'énumération 
     <span class="codeph"> mediacore.PSDKErrorCode</span> répertorie les valeurs possibles.
    </pre> </td> 
  </tr> 
  <tr rowsep="1"> 
