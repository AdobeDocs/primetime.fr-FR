---
description: Vous pouvez fournir des informations de style pour les pistes de sous-titrage à l’aide de la classe ClosedCaptionStyles. Définit le style de toutes les sous-titres qui sont affichés par votre lecteur.
seo-description: Vous pouvez fournir des informations de style pour les pistes de sous-titrage à l’aide de la classe ClosedCaptionStyles. Définit le style de toutes les sous-titres qui sont affichés par votre lecteur.
...
Vous pouvez fournir des informations de style pour les pistes de sous-titrage à l’aide de la classe ClosedCaptionStyles. Définit le style de toutes les sous-titres qui sont affichés par votre lecteur.

Cette classe encapsule les informations de style de sous-titrage, telles que le type, la taille, la couleur et l’opacité de l’arrière-plan. Une classe d’assistance associée `ClosedCaptionStylesBuilder`facilite l’utilisation des paramètres de style de sous-titrage.
...
1. Pour modifier les paramètres de style, effectuez l’une des opérations suivantes :
   ...
   * Utilisez la classe `ClosedCaptionStylesBuilder` d’assistance (fonctionne `ClosedCaptionStyles` en arrière-plan).
...
Vous pouvez fournir des informations de style pour les pistes de sous-titrage à l’aide de la `ClosedCaptionStyles` classe. Définit le style de toutes les sous-titres qui sont affichés par votre lecteur.
...
<table frame="all" colsep="1" rowsep="1" id="table_87205DEFEE384AF4AF83952B15E18A42"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Type de police. </p> <p>Peut uniquement être définie sur une valeur définie par le <span class="codeph"> tableau ClosedCaptionStyles.FONT </span> et représente, par exemple, un espacement fixe avec ou sans sérifs. 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>La taille de la légende. </p> <p> Peut uniquement être définie sur une valeur définie par le <span class="codeph"> tableau ClosedCaptionStyles.FONT_SIZE </span> : 
     ...
     </ul> </p> <p>Conseil :  Vous pouvez modifier la taille de police des légendes WebVTT en modifiant le paramètre de taille de la <span class="codeph"> </span> fonction de définition DefaultMediaPlayer.ccStyles. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"> Bordure de la police </td> 
   <td colname="2"> <p>Effet utilisé pour le bord de la police, par exemple relevé ou aucun. </p> <p>Peut uniquement être définie sur une valeur définie par le <span class="codeph"> tableau ClosedCaptionStyles.FONT_EDGE </span> . 
     <code class="syntax actionscript">
...
## Exemple 2 : Définition des valeurs de format dans les paramètres {#section_147036D7C31C4010A5A7DF49997014A9}
