...
1. Dans `retrieveGenerators`, utilisez le `SpliceInPlacementOpportunityGenerator`.
   ...
   Pour plus d’informations sur l’utilisation d’une personnalisation `ContentFactory`, voir l’étape 1 dans [Mise en oeuvre d’un créateur](../../ad-insertion/content-resolver/t-psdk-android-2.7-opp-detector-impl-android.md)d’opportunités personnalisé.
