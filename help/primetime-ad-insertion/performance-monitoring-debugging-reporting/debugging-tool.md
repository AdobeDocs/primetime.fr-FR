...
### TRACE_WEBVTT_REQUEST enregistrements {#trace-webvtt-request-records}
...
* Tentative d’assemblage de la publicité à `HH:MM:SS` : AdPlacement \[adManifestURL=*et URL du manifeste*, durationSeconds=*secondes*, ignore=*ignore*, redirectAd=*publicité de redirection*, priority=*priority*\].
