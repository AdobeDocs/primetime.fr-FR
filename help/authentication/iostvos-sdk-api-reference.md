...
* *options*: NSDictionary contenant les options du SDK global. Actuellement, les options suivantes sont disponibles :
   ...
   * **handleSVC** - Valeur booléenne indiquant si le programmeur va gérer les SFSafariViewController. Veuillez consulter [Prise en charge de SFSafariViewController sur le SDK iOS 3.2+](/help/authentication/sfsafariviewcontroller-support-on-ios-sdk-32.md) pour plus d’informations.
