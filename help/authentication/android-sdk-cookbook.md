...
1. Créez vos fonctions de rappel :
   ...
   - [navigateToUrl(url)](#$navigateToUrl)
      ...
      Déclenché par `getAuthentication()` une fois que l’utilisateur a sélectionné un MVPD. Le `url` fournit l’emplacement de la page de connexion du MVPD.
...
1. Lancement de l’authentification Adobe Primetime
   ...
   b. Appeler` setRequestor()` d&#39;établir l&#39;identification du programmeur; transmettez le `requestorID` et (éventuellement) un tableau de points de terminaison d’authentification Adobe Primetime.
...
1. Fermez le contrôle et l’appel WebView `getAuthenticationToken()`, qui demande à AccessEnabler de récupérer le jeton d’authentification du serveur principal. 
