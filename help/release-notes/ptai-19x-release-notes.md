...
* CRS : Possibilité Ajoutée de liste bloquée/liste autorisée des demandes CRS provenant de systèmes publicitaires spécifiques, d’ID d’annonce, d’ID créatifs, d’URL créatives et/ou de format créatif
