...
seo-description: Si le client demande des informations de suivi au format JSON, le serveur de manifeste renvoie un fichier dans l’un des formats JSON.
seo-title: Formats JSON pour le suivi des URL
